...
function File(d, a, c, b, e) {
    ...
    this.Delete = function () {
        ...
        g = RoxyUtils.AddParam(g, "rf", $('#rootFolderName').val());
        var f = this;
        $.ajax({
            url: g,
            type: "POST",
    ...
    this.Rename = function (f) {
        ...
        h = RoxyUtils.AddParam(h, "rf", $('#rootFolderName').val());
        var j = this;
        var g = false;
        $.ajax({
            url: h,
...
function Directory(a, c, b) {
    ...
    this.LoadAll = function (d) {
        ...
        e = RoxyUtils.AddParam(e, "rf", $('#rootFolderName').val());
        var g = this;
        $.ajax({
            url: e,
            type: "POST",
    ...
    this.Create = function (d) {
        ...
        f = RoxyUtils.AddParam(f, "rf", $('#rootFolderName').val());
        var g = this;
        var e = false;
        $.ajax({
            url: f,
    ...
    this.LoadFiles = function (g, f) {
        ...
        d = RoxyUtils.AddParam(d, "rf", $('#rootFolderName').val());
        var h = this;
        if (!this.IsListed() || g) {
            $.ajax({
                url: d,
...
function fileUpload(e, c) {
    ...
    a.append("rf", $('#rootFolderName').val());
    a.append("files[]", e);
...
function downloadFile() {
    ...
    if (b && RoxyFilemanConf.DOWNLOAD) {
        ...
        a = RoxyUtils.AddParam(a, "rf", $('#rootFolderName').val());
    ...
    if ($("#hdViewType").val() == "thumb" && b.IsImage()) {
        ...
        if (b.IsImage()) {
            if (RoxyFilemanConf.GENERATETHUMB) {
                ...
                imgUrl = RoxyUtils.AddParam(imgUrl, "rf", $('#rootFolderName').val())
            } else {
                imgUrl = b.fullPath
            }
    ...
    if (a == "thumb") {
        ...
        $("#pnlFileList li").each(function () {
            ...
            if (RoxyFilemanConf.GENERATETHUMB && RoxyUtils.IsImage($(this).attr("data-path"))) {
                ...
                c = RoxyUtils.AddParam(c, "rf", $('#rootFolderName').val())
            }
...
$(function () {
    ...
    var e = new Directory();
    $("#rootFolderName").val(RoxyUtils.GetUrlParam("articleId"));
    e.LoadAll();
    $("#wraper").show();
...
AddRootFolderName = function (data) {
    data.rootFolderName = $('#rootFolderName').val();
    return data;
};
